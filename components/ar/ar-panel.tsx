...
import { Customer, Payment, PaymentApplication, CreditEntry } from '@/lib/ar-data';
...
export default function ArPanel({ customer, onAddPayment, onAddCreditEntry, onDeleteCreditEntry, onApplyPayment, onUnapplyPayment }: ArPanelProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-6 px-6">
      ...
      <div className="bg-white border border-gray-200 border-t-0 rounded-b-lg p-5 shadow-sm">
        {activeTab === 'charges' && <ChargesTab customer={customer} onAddCreditEntry={onAddCreditEntry} onUnapplyPayment={onUnapplyPayment} onApplyPayment={onApplyPayment} />}
        {activeTab === 'payments' && <PaymentsTab customer={customer} onAddPayment={onAddPayment} />}
