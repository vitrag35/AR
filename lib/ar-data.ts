...
export const DB: Record<string, Customer> = {
  c1: {
    ...
    charges: [
      ...
      { id: 'i8', num: 'INV-2024-004', ref: 'PO-4456', date: '2024-03-10', due: '2024-04-10', amount: 2800, paid: 0 },
      { id: 'i9', num: 'INV-2024-005', ref: 'PO-4457', date: '2024-03-15', due: '2024-04-15', amount: 1900, paid: 500 },
      { id: 'i10', num: 'INV-2024-006', ref: 'PO-4458', date: '2024-03-20', due: '2024-04-20', amount: 4200, paid: 0 },
      { id: 'i11', num: 'INV-2024-007', ref: 'PO-4459', date: '2024-03-22', due: '2024-04-22', amount: 2500, paid: 2500 },
      { id: 'i12', num: 'INV-2024-008', ref: 'PO-4460', date: '2024-03-25', due: '2024-04-25', amount: 3300, paid: 0 },
      { id: 'i13', num: 'INV-2024-009', ref: 'PO-4461', date: '2024-03-28', due: '2024-04-28', amount: 1600, paid: 0 },
    ],
    payments: [
      ...
      { id: 'p7', customerId: 'c1', date: '2024-03-12', type: 'WIRE', ref: 'WIRE-1001', amount: 1800, applied: 1800, notes: '', user: 'Mike Davis', transactionType: 'PAYMENT' },
      { id: 'p8', customerId: 'c1', date: '2024-03-18', type: 'CREDIT_CARD', ref: 'CC-0001-2024', amount: 2500, applied: 2500, notes: 'Stripe payment', user: 'Lisa Anderson', transactionType: 'PAYMENT' },
      { id: 'p9', customerId: 'c1', date: '2024-03-24', type: 'CHECK', ref: 'CHK-1025', amount: 3200, applied: 0, notes: '', user: 'John Smith', transactionType: 'PAYMENT' },
      { id: 'p10', customerId: 'c1', date: '2024-03-26', type: 'ACH', ref: 'ACH-5545', amount: 1500, applied: 0, notes: 'Direct transfer', user: 'Sarah Johnson', transactionType: 'PAYMENT' },
      { id: 'p11', customerId: 'c1', date: '2024-03-28', type: 'WIRE', ref: 'WIRE-1002', amount: 4500, applied: 0, notes: '', user: 'Mike Davis', transactionType: 'PAYMENT' },
      { id: 'p12', customerId: 'c1', date: '2024-03-29', type: 'CASH', ref: 'CASH-0001', amount: 800, applied: 0, notes: 'In person payment', user: 'Lisa Anderson', transactionType: 'PAYMENT' },
      { id: 'p13', customerId: 'c1', date: '2024-03-30', type: 'CHECK', ref: 'CHK-1026', checkDate: '2024-03-30', amount: 1200, applied: 0, notes: 'Pending clearance', user: 'John Smith', transactionType: 'PAYMENT' },
    ],
    creditEntries: [
      ...
      { id: 'ce4', customerId: 'c1', type: 'RETURN', date: '2024-03-23', reason: 'Product return', amount: 500, applied: 0, ref: 'RTN-001', user: 'Sarah Johnson' },
      { id: 'ce5', customerId: 'c1', type: 'DISCOUNT', date: '2024-03-25', reason: 'Early payment discount', amount: 150, applied: 0, ref: 'DSC-001', user: 'Lisa Anderson' },
      { id: 'ce6', customerId: 'c1', type: 'ADJUSTMENT', date: '2024-03-27', reason: 'Quality adjustment', amount: 300, applied: 0, ref: 'ADJ-002', user: 'Mike Davis' },
      { id: 'ce7', customerId: 'c1', type: 'RETURN', date: '2024-03-28', reason: 'Damaged shipment', amount: 750, applied: 0, ref: 'RTN-002', user: 'John Smith' },
      { id: 'ce8', customerId: 'c1', type: 'DISCOUNT', date: '2024-03-29', reason: 'Loyalty discount', amount: 200, applied: 0, ref: 'DSC-002', user: 'Sarah Johnson' },
    ],
    applications: [
